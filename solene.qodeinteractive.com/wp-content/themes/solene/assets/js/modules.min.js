    ...
    function t() {
        m().init(), -1 < navigator.appVersion.toLowerCase().indexOf("mac") && eltdf.body.hasClass("eltdf-smooth-scroll") && eltdf.body.removeClass("eltdf-smooth-scroll"), o().init(), T("#eltdf-back-to-top").on("click", function(e) {
                ...
                e.length && e.each(function() {
                    ...
                    t.on("keyup paste", function() {
                        ...
                        a.attr("autocomplete", "off"), n.removeClass("eltdf-hidden"), d.addClass("eltdf-hidden"), clearTimeout(i), i = setTimeout(function() {
                            var e = a.val();
                            if (e.length < 3) l.html(""), l.fadeOut(), n.addClass("eltdf-hidden"), d.removeClass("eltdf-hidden");
                            else {
                                var t = {
            ...
            function() {
                ...
                e.length && e.each(function() {
                    var e = T(this),
                        n = e.find("button.eltdf-dashboard-form-button"),
                    ...
                    e.on("submit", function(e) {
                        ...
                        t.each(function() {
                            ...
                            0 === n.length && f.append(e, new File([""], "eltdf-dummy-file.txt", {
                                type: "text/plain"
                            }));
                ...
                if (eltdf.body.hasClass("eltdf-smooth-page-transitions")) {
                    if (eltdf.body.hasClass("eltdf-smooth-page-transitions-preloader")) {
                        ...
                        e.length ? 0 !== l.find(".eltdf-solene-spinner").length ? (setTimeout(function() {
                            ...
                            1300 < eltdf.window.scrollTop() ? T(".eltdf-content").find(".eltdf-uncover-row").css({
                                position: "fixed"
                            }) : T(".eltdf-content").find(".eltdf-uncover-row").css({
                                position: "static"
                            })
    ...
    function l() {
        c(), P(),
            function() {
                ...
                if (e.length) {
                    var t = parseInt(e.css("bottom"), 10),
                        a = e.width();
                    e.css({
                        bottom: a + t + "px",
                        opacity: 1
        ...
        i = i || 5, o = o || .03, T(e).on("mouseenter", function() {
            ...
            s(function e() {
                ...
                if (0 != Math.round(a)) {
                    if (l.find(d).css({
                            filter: "blur(" + t + "px)"
                        }), a = t, !(Math.round(a) <= i + 1 / i)) return r(e), !1;
                    s(e)
                }
                ...
                s(function e() {
                    ...
                    if (0 != Math.round(a)) {
                        if (l.find(d).css({
                                filter: "blur(" + t + "px)"
                            }), a = t, !(0 < Math.round(a))) return l.find(d).css({
                            filter: "blur(0px)"
                        }), r(e), !1;
                        s(e)
                    }
        ...
        return {
            init: function() {
                T("[data-eltdf-anchor]").length && (eltdf.document.on("click", ".eltdf-main-menu a, .eltdf-fullscreen-menu a, a.eltdf-btn, .eltdf-anchor, .eltdf-mobile-nav a, .eltdf-vertical-menu a", function() {
                    ...
                    if ("" !== a && 0 < l.length) {
                        var n = l.offset().top;
                        return e = n - o(n) - eltdfGlobalVars.vars.eltdfAddForAdminBar, i(t), eltdf.html.stop().animate({
    ...
    function u(e, t, a, l) {
        if (e.hasClass("eltdf-masonry-images-fixed") || !0 === l) {
            var n = parseInt(t.css("paddingLeft"), 10),
                d = a - 2 * n,
                i = e.find(".eltdf-masonry-size-small"),
                o = e.find(".eltdf-masonry-size-large-width"),
        ...
        function a() {
            m.length && T.each(m, function(e) {
                ...
                if (1024 < eltdf.windowWidth && d.length) {
                    var s = -(a - u),
                        r = l - a - 40,
                        f = i + t - u - a - eltdfGlobalVars.vars.eltdfTopBarHeight;
                    if (eltdf.scroll >= t - u && l < i)
                        if (d.hasClass("eltdf-sticky-sidebar-appeared") ? d.css({
                                top: s + "px"
                            }) : d.addClass("eltdf-sticky-sidebar-appeared").css({
                                position: "fixed",
                                top: s + "px",
                                width: n,
                                "margin-top": "-10px"
...
function(f) {
    ...
    function t() {
        ! function() {
            var l, n = f(".eltdf-wrapper"),
                d = f(".eltdf-side-menu"),
                i = f("a.eltdf-side-menu-button-opener"),
                o = !1,
                s = !1,
                r = !1;
...
function(o) {
    ...
    function t() {
        ! function() {
            var e = o(".eltdf-subscribe-popup-holder"),
                t = o(".eltdf-sp-close");
            if (e.length) {
                var a = e.find(".eltdf-sp-prevent"),
                    l = "no";
                if (a.length) {
                    var n = e.hasClass("eltdf-sp-prevent-cookies"),
                        d = a.find(".eltdf-sp-prevent-input"),
                        i = d.data("value");
        ...
        ! function() {
            ...
            if (0 < e.length && 1024 < eltdf.windowWidth) {
                ...
                e.css({
                    ...
                    "background-size": l - eltdf.scroll + "px auto"
                }), o(window).scroll(function() {
                    d = -eltdf.scroll * n, e.css({
                        "background-position": "center " + (d + i) + "px"
                    }), t && e.css({
                        "background-size": l - eltdf.scroll + "px auto"
                    })
    ...
    function t() {
        s(document).on("click", ".eltdf-quantity-minus, .eltdf-quantity-plus", function(e) {
                ...
                var t, a = s(this),
                    ...
                    n = parseFloat(l.data("step")),
                    d = parseFloat(l.data("max")),
                    i = !1,
                    o = parseFloat(l.val());
    ...
    function l() {
        ...
        var e = h(".eltdf-blog-list-holder"),
            n = function(a, e) {
                ...
                var t = eltdf.modules.common.getLoadMoreData(a),
                    i = a.find(".eltdf-blog-pag-loading");
                l = t.nextPage;
            ...
            r = function(e, t, a) {
                var l = e.find(".eltdf-bl-standard-pagination"),
                    n = l.find("li.eltdf-pag-number"),
                    d = l.find("li.eltdf-pag-prev a"),
                    i = l.find("li.eltdf-pag-next a");
                n.removeClass("eltdf-pag-active"), n.eq(a - 1).addClass("eltdf-pag-active"), d.data("paged", a - 1), i.data("paged", a + 1), 1 < a ? d.css({
                    opacity: "1"
                }) : d.css({
                    opacity: "0"
                }), a === t ? i.css({
            ...
            f = function(e, t, a, l) {
                var n = "";
                t.children('[class*="-grid-sizer"]').length && (n += t.children('[class*="-grid-sizer"]')[0].outerHTML), t.children('[class*="-grid-gutter"]').length && (n += t.children('[class*="-grid-gutter"]')[0].outerHTML), t.html(n + l).isotope("reloadItems").isotope({
                    sortBy: "original-order"
...
function(f) {
    ...
    function t() {
        ! function() {
            ...
            if (t.length) {
                var a, e = f(".eltdf-fullscreen-menu-holder-outer"),
                    l = !1,
                    n = !1,
        ...
        ! function() {
            ...
            e.length && e.each(function() {
                ...
                n.on("tap click", function(e) {
                    ...
                    if (t.hasClass("has_sub")) {
                        var l = t.find("> ul.sub_menu");
                        l.is(":visible") ? (l.slideUp(450, "easeInOutQuint"), t.removeClass("eltdf-opened"), i.stop().animate({
                            height: d
                        }, 300)) : (t.addClass("eltdf-opened"), 0 === a.length ? t.find(".sub_menu").slideUp(400, "easeInOutQuint", function() {
                            l.slideDown(400, "easeInOutQuint"), i.stop().animate({
                                height: d + 50
                            }, 300)
            ...
            function() {
                ...
                if (eltdf.body.hasClass("eltdf-sticky-up-mobile-header")) {
                    var l, n = o("#wpadminbar"),
                        d = o(document).scrollTop();
                ...
                0 < e.length && e.each(function() {
                    u(this).on("click", function(e) {
                        ...
                        var t, a = u(this),
                            ...
                            n = u(".eltdf-top-bar"),
                            d = l.find(".eltdf-fixed-wrapper.fixed"),
                            i = u(".eltdf-mobile-header"),
                            o = u(".eltdf-search-cover"),
    ...
    function t() {
        ! function() {
            if (eltdf.body.hasClass("eltdf-fullscreen-search")) {
                ...
                if (0 < e.length) {
                    var a = d(".eltdf-fullscreen-search-holder"),
                        t = d(".eltdf-search-close");
            ...
            if (eltdf.body.hasClass("eltdf-slide-from-header-bottom")) {
                ...
                e.length && e.each(function() {
                    m(this).on("click", function(e) {
                        ...
                        var l = m(".eltdf-page-header"),
                            n = "100%",
                            d = m(".eltdf-top-bar"),
                            i = l.find(".eltdf-fixed-wrapper.fixed"),
...
function(r) {
    ...
    var a = function() {
        ...
        if (a.length) var l = a.parent().height(),
        ...
        ! function() {
            ...
            e.length && e.each(function() {
                ...
                a.find(".eltdf-pgs-gallery-filter:first").addClass("eltdf-pgs-filter-current"), a.find(".eltdf-pgs-gallery-filter").on("click", function() {
                    ...
                    e.parent().children(".eltdf-pgs-gallery-filter").removeClass("eltdf-pgs-filter-current"), e.addClass("eltdf-pgs-filter-current"), a.parent().children(".eltdf-pgs-gallery-inner").isotope({
                        filter: t
                    })
                })
            })
            ...
            function() {
                ...
                if (e.hasClass("eltdf-password-protected-full-height")) {
                    ...
                    e.css({
                        height: eltdf.windowHeight - e.offset().top - t + "px"
                    }), eltdf.body.hasClass("eltdf-pg-password-protected-full-height") || eltdf.body.addClass("eltdf-pg-password-protected-full-height")
                }
            }()
                ...
                e.length && e.each(function() {
                    ! function(e) {
                        e.find(".eltdf-pgs-gallery-image").each(function() {
                            var a = n(this),
                                l = a.find(".eltdf-pgs-image-action-icon");
                            l.on("click", function() {
...
function(o) {
    ...
    function a() {
        ...
        if (e.length && 1024 < eltdf.windowWidth) {
            ...
            var t = o("div[data-eltdf-anchor]"),
                i = e.find(".eltdf-anchor");
            t.length && i.length && (i.first().addClass("eltdf-active"), o(window).scroll(function() {
                t.each(function(e) {
                    var t = o(this),
                        a = t.offset().top,
                        l = t.outerHeight(),
                        n = eltdf.windowHeight / 5,
                        d = 0;
...
function(n) {
    ...
    function a() {
        var a, l, e = n(".eltdf-grow-in, .eltdf-fade-in-down, .eltdf-element-from-fade, .eltdf-element-from-left, .eltdf-element-from-right, .eltdf-element-from-top, .eltdf-element-from-bottom, .eltdf-flip-in, .eltdf-x-rotate, .eltdf-z-rotate, .eltdf-y-translate, .eltdf-fade-in, .eltdf-fade-in-left-x-rotate");
        e.length && e.each(function() {
            var t = n(this);
            t.appear(function() {
...
function(g) {
    ...
    function a() {
        var n, d, i, o, s, r, f, c, u, m, h, e = g(".eltdf-countdown"),
            p = (new Date).getMonth();
        e.length && e.each(function() {
    ...
    function n() {
        ...
        e.length && e.each(function() {
            var e = s(this),
                ...
                i = e.find(".eltdf-cf-typed-4").text();
...
function(o) {
    ...
    function d(t) {
        ...
        if (t.find(".eltdf-fsis-item").removeClass("eltdf-fsis-content-image-init"), function(e) {
            ...
            var a = e.find(".eltdf-fsis-item"),
                l = a.children(".eltdf-fsis-image");
            setTimeout(function() {
...
function(c) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var l = c(this),
                e = l.children(".eltdf-fss-wrapper"),
                n = e.children(".eltdf-fss-item"),
                d = n.length,
                i = n.hasClass("eltdf-fss-item-has-style"),
                t = !1,
                a = "",
                o = "",
                s = "";
    ...
    function m(e, t, a) {
        var l = e,
            n = l.find("#eltdf-fss-nav-up"),
            d = l.find("#eltdf-fss-nav-down"),
            i = !1;
...
function(p) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var e, t, a, l, n, d, i, o, s, r, f = p(this),
                c = !1,
                u = "";
            if (void 0 !== f.data("snazzy-map-style") && "yes" === f.data("snazzy-map-style")) {
                c = !0;
                var m = f.parent().find(".eltdf-snazzy-map"),
                    h = m.val();
                m.length && h.length && (u = JSON.parse(h.replace(/`{`/g, "[").replace(/`}`/g, "]").replace(/``/g, '"').replace(/`/g, "")))
            }
            void 0 !== f.data("custom-map-style") && (e = f.data("custom-map-style")), void 0 !== f.data("color-overlay") && !1 !== f.data("color-overlay") && (t = f.data("color-overlay")), void 0 !== f.data("saturation") && !1 !== f.data("saturation") && (a = f.data("saturation")), void 0 !== f.data("lightness") && !1 !== f.data("lightness") && (l = f.data("lightness")), void 0 !== f.data("zoom") && !1 !== f.data("zoom") && (n = f.data("zoom")), void 0 !== f.data("pin") && !1 !== f.data("pin") && (d = f.data("pin")), void 0 !== f.data("height") && !1 !== f.data("height") && (i = f.data("height")), void 0 !== f.data("unique-id") && !1 !== f.data("unique-id") && (o = f.data("unique-id")), void 0 !== f.data("scroll-wheel") && (s = f.data("scroll-wheel")), void 0 !== f.data("addresses") && !1 !== f.data("addresses") && (r = f.data("addresses")),
                function(e, t, a, l, n, d, i, o, s, r, f, c, u, m) {
...
function(g) {
    ...
    function a() {
                ...
                d = t.data("distance"), a.timelineNavWrapper = t.find(".eltdf-ht-nav-wrapper"), a.timelineNavWrapperWidth = a.timelineNavWrapper.width(), a.timelineNavInner = a.timelineNavWrapper.find(".eltdf-ht-nav-inner"), a.fillingLine = a.timelineNavInner.find(".eltdf-ht-nav-filling-line"), a.timelineEvents = a.timelineNavInner.find("a"), a.timelineDates = function(e) {
                    ...
                    function(e, t) {
                        for (var a = 0; a < e.timelineDates.length; a++) {
                            var l = h(e.timelineDates[0], e.timelineDates[a]),
                                n = Math.round(l / e.eventsMinLapse) + 2;
        ...
        function o(e, t, a) {
            var l = window.getComputedStyle(t.get(0), null),
                n = Number(l.getPropertyValue("left").replace("px", "")),
                d = Number(a.timelineNavWrapper.css("width").replace("px", "")),
                i = Number(a.timelineNavInner.css("width").replace("px", "")),
                o = u(a.timelineNavInner);
        ...
        function r(e, t, a) {
            var l = window.getComputedStyle(e.get(0), null),
                n = l.getPropertyValue("left"),
        ...
        function f(e, t) {
            var a = e.data("date"),
                l = t.find(".eltdf-selected"),
                n = t.find('[data-date="' + a + '"]'),
                d = n.height(),
                i = "eltdf-selected eltdf-enter-left",
                o = "eltdf-leave-right";
...
function(d) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var e = d(this).children(".eltdf-ig-slider"),
                t = "",
                n = "";
            e.each(function() {
                var e = d(this),
...
function(m) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            ...
            var a, l, n, d, i, o, t = m(this),
                s = t.find(".eltdf-iwt-image"),
                r = t.find(".eltdf-iwt-frame"),
                f = t.find(".main-image"),
                c = !1,
                u = t.hasClass("eltdf-scrolling-horizontal");
            t.waitForImages(function() {
        ...
        e.length && e.each(function() {
            ...
            if (a.hasClass("eltdf-ils-standard")) {
                ...
                l.length && l.on("mouseenter", function() {
                    ...
                    var t = b(this),
                        a = t.find(".eltdf-ils-follow-content"),
                        l = a.find(".eltdf-ils-follow-image"),
                        n = l.find("img"),
                        d = n.width(),
                        i = parseInt(l.data("images-count"), 10),
                        o = l.data("images"),
                        s = a.find(".eltdf-ils-follow-title"),
                        r = t.outerWidth(),
                        f = t.outerHeight(),
                        c = t.offset().top - eltdf.scroll,
                        u = t.offset().left;
...
function(d) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var t = d(this),
                e = t.find(".eltdf-is-left"),
                a = t.find(".eltdf-is-right"),
                l = t.find(".eltdf-is-image");
            ...
            e.wrapAll("<div class='eltdf-is-item-holder eltdf-is-left-holder' />"), a.wrapAll("<div class='eltdf-is-item-holder eltdf-is-right-holder' />"), t.animate({
                opacity: 1
            }, 200), setTimeout(function() {
                t.appear(function() {
...
function(d) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var e = d(this),
                t = e.children(".eltdf-pc-percentage"),
                a = "#afafa5",
                l = "#f7f7f7",
                n = 176;
...
function(n) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var e = n(this),
                t = e.find(".eltdf-pb-content"),
                a = e.find(".eltdf-pb-percent"),
                l = t.data("percentage");
            e.appear(function() {
                ! function(e, t) {
                    var a = parseFloat(t);
                ...
                }(a, l), t.css("width", "0%").animate({
                    width: l + "%"
                }, 2e3), e.hasClass("eltdf-pb-percent-floating") && a.css("left", "0%").animate({
                    left: l + "%"
                }, 2e3)
            })
        })
        ...
        e.length && e.each(function() {
            ...
            e.children(".eltdf-tab-container").each(function(e) {
                ...
                var t = d(this),
                    ...
                    n = l.attr("href"); - 1 < (a = "#" + a).indexOf(n) && l.attr("href", a)
...
function(r) {
    ...
    function a() {
        var i = r(".eltdf-vertical-split-slider"),
            o = !0;
        if (i.length) {
            eltdf.body.hasClass("eltdf-vss-initialized") && (eltdf.body.removeClass("eltdf-vss-initialized"), r.fn.multiscroll.destroy()), setTimeout(function() {
                i.height(eltdf.windowHeight).animate({
                    opacity: 1
                }, 800)
            }, 500);
            var s = "";
            eltdf.body.hasClass("eltdf-light-header") ? s = "light" : eltdf.body.hasClass("eltdf-dark-header") && (s = "dark"), i.multiscroll({
                ...
                afterRender: function() {
                    ...
                    var t = r('<div class="eltdf-vss-responsive"></div>'),
                        a = i.find(".eltdf-vss-ms-left > div"),
    ...
    function l() {
        ...
        return {
            init: function() {
                e.length && e.each(function() {
                    var e = a(this),
                        t = e.find(".eltdf-mg-grid-sizer").outerWidth();
                    ! function(t, a) {
                        t.waitForImages(function() {
                            var e = t.children();
                            e.isotope({
...
function(m) {
    ...
    function t() {
        a.init(), eltdf.modules.common.eltdfBlurImage(".eltdf-horizontal-scrolling-portfolio-holder .eltdf-hspl-item-inner", ".eltdf-hspli-image img"),
            function() {
    ...
    var a = {
        ...
        calcHolderHeight: function(e) {
            var t = eltdf.windowHeight,
                a = e.currentHolder.data("header-decrease"),
                l = m(".eltdf-content-bottom"),
                n = l.length ? e.currentHolder.data("content-bottom-decrease") : "no";
            "yes" === a && (t -= e.holderOffset), "yes" === n && l.length && (t -= l.outerHeight()), e.listInner.css({
                height: t
            })
        },
        ...
        setItemWidth: function(s) {
            var r = 0,
                f = s.featureItem.length ? s.items.length - 1 : s.items.length,
                c = 0,
                u = s.listInner.height();
            s.items.each(function() {
                var e = m(this),
                    t = 0,
                    a = 0,
                    l = e.find(".eltdf-hspl-item-content"),
        ...
        devicesInit: function(a) {
            ...
            var d = function() {
                ...
                var e = "translate3d(" + (n += .08 * (l - n)) + "px, 0px, 0px)",
                    t = a.section.style;
...
function(m) {
            ...
            e.length && e.each(function() {
                ...
                n.find(".eltdf-pl-filter:first").addClass("eltdf-pl-current"), d.hasClass("eltdf-pl-gallery") && i.isotope(), n.find(".eltdf-pl-filter").on("click", function() {
                    ...
                    e.parent().children(".eltdf-pl-filter").removeClass("eltdf-pl-current"), e.addClass("eltdf-pl-current"), o && !l && t.length ? function l(e, t, a) {
                        ...
                        var r = eltdf.modules.common.getLoadMoreData(n),
                            f = r.nextPage,
                        ...
                        f <= s && (u.addClass("eltdf-showing eltdf-filter-trigger"), d.css("opacity", "0"), m.ajax({
                            ...
                            success: function(e) {
                                ...
                                n.waitForImages(function() {
                                    d.append(a).isotope("reloadItems").isotope({
                                        sortBy: "original-order"
                                    });
                                    var e = !!d.children().hasClass(o);
                                    e ? setTimeout(function() {
                                        eltdf.modules.common.setFixedImageProportionSize(n, d.find("article"), d.find(".eltdf-masonry-grid-sizer").width(), !0), d.isotope("layout").isotope({
                                            filter: i
                                        }), u.removeClass("eltdf-showing eltdf-filter-trigger"), setTimeout(function() {
                    ...
                    }(d, t, a) : (t = 0 === t.length ? "*" : t, n.parent().children(".eltdf-pl-inner").isotope({
                        filter: t
                    }), eltdf.modules.common.eltdfInitParallax())
                })
            })
    ...
    function l() {
        ...
        var e = m(".eltdf-portfolio-list-holder"),
            ...
            r = function(e, t, a, l) {
                t.find("article").remove(), t.append(l), eltdf.modules.common.setFixedImageProportionSize(e, t.find("article"), t.find(".eltdf-masonry-grid-sizer").width(), !0), t.isotope("reloadItems").isotope({
                    sortBy: "original-order"
            ...
            c = function(e, t, a, l) {
                t.append(l), eltdf.modules.common.setFixedImageProportionSize(e, t.find("article"), t.find(".eltdf-masonry-grid-sizer").width(), !0), t.isotope("reloadItems").isotope({
                    sortBy: "original-order"
...
function(n) {
    ...
    function a() {
        ! function() {
            ...
            e.length && e.each(function() {
                var t = n(this).find(".eltdf-owl-slider"),
                    a = !0;
    ...
    function l() {
        var e = n(".eltdf-portfolio-slider-full-screen .owl-item"),
            t = n(".eltdf-page-header").height(),
            a = n(".eltdf-page-footer").height(),
            l = n(".eltdf-content-bottom").height();
        e.length && e.each(function() {
            n(this).css({
                height: "calc(100vh - " + (t + a + l) + "px)"
            })
        })
    }
...
function(m) {
    ...
    function t() {
        ! function() {
            ...
            e.length && e.each(function() {
                var i, o, s = m(this),
                    e = m(".eltdf-page-header"),
                    r = m(".eltdf-mobile-header"),
                    t = e.outerHeight(),
                ...
                m(eltdf.body).on("click", ".eltdf-pvli-content-holder .eltdf-pvli-content-link", function(e) {
                        ...
                        var a = eltdf.window.scrollTop(),
                            l = t.closest("article").offset().top - a - i - f;
...
function(m) {
    ...
    function l() {
        ...
        var e = m(".eltdf-proofing-gallery-list-holder"),
            n = function(a, e) {
            ...
            s = function(e, t, a) {
                var l = e.find(".eltdf-pgl-standard-pagination"),
                    n = l.find("li.eltdf-pag-number"),
                    d = l.find("li.eltdf-pag-prev a"),
                    i = l.find("li.eltdf-pag-next a");
                n.removeClass("eltdf-pag-active"), n.eq(a - 1).addClass("eltdf-pag-active"), d.data("paged", a - 1), i.data("paged", a + 1), 1 < a ? d.css({
            ...
            r = function(e, t, a, l) {
                t.html(l).isotope("reloadItems").isotope({
                    sortBy: "original-order"
                }), a.removeClass("eltdf-showing eltdf-standard-pag-trigger"), e.removeClass("eltdf-pgl-pag-standard-animate"), setTimeout(function() {
                    t.isotope("layout"), d()
                }, 400)
            },
            f = function(e, t, a, l) {
            ...
            e.length && e.each(function() {
                var e = l(this),
                    ...
                    a = new Swiper(t, {
                        ...
                        speed: 500,
                        navigation: {
                            prevEl: e.find(".eltdf-prev-icon"),
                            nextEl: e.find(".eltdf-next-icon")
                        },
                        pagination: {
