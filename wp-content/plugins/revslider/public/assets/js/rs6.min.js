...
! function(e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID, window.RSANYID_sliderID = window.RSANYID_sliderID === t ? [] : window.RSANYID_sliderID, e.fn.extend({
            ...
            if (a !== t && i[a] !== t && "clicked" !== i[a].modal.closeProtection) {
                ...
                switch (r.mode) {
                    case "show":
                        ...
                        break;
                    case "close":
                        S(a), document.body.style.overflow = window.overscrollhistory, i[a].modal.bodyclass !== t && i[a].modal.bodyclass.length >= 0 && document.body.classList.remove(i[a].modal.bodyclass), punchgs.TweenMax.to(i[a].modal.bg, 2, {
                            display: "none",
                            opacity: 0,
                            ease: punchgs.Power3.easeInOut
                    ...
                    if (l.hasOwnProperty(c)) {
                        ...
                        for (d in p)
                            if (p.hasOwnProperty(d) && "length" !== d && !(p[d].className.indexOf("rs-pzimg") >= 0)) {
                                ...
                                m && m.progress && m.progress.match(/inprogress|inload|prepared/g) && (!m.error && e.now() - m.starttoload < 3e3 ? n = !0 : (m.progress = "failed", m.reported_img || (m.reported_img = !0, console.log(f + "  Could not be loaded !")))), 1 != i[o].youtubeapineeded || window.YT && YT.Player != t || (n = R("youtube", o)), 1 != i[o].vimeoapineeded || window.Vimeo || (n = R("vimeo", o))
                            }
        ...
        enterInViewPort: function(a) {
            i[a].waitForCountDown && (O(a), i[a].waitForCountDown = !1), i[a].waitForFirstSlide && (z(a), i[a].waitForFirstSlide = !1, setTimeout(function() {
            ...
            if (i[r] !== t) {
                ...
                if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({
                    ...
                    if (A.length < 9 && A.split("slide").length > 1 && -1 == A.indexOf("slider")) {
                        ...
                        e.isNumeric(parseInt(R, 0)) && ((R = parseInt(R, 0)) < 1 && (R = 1), R > i[r].slideamount && (R = i[r].slideamount), i[r].startWithSlide = R - 1)
                    }
                    ...
                    i[r].c.height(S.height), 0 === i[r].c.find("rs-progress").length && i[r].c.append('<rs-progress style="visibility:hidden"></rs-progress>'), i[r].c.find("rs-progress").css({
                        width: "0%"
                    }), i[r].canvas.css({
                        display: "block"
                    ...
                    i[r].inviewport = !1, M != t && M.enable && i.scrollTicker && i.scrollTicker(r), i[r].slides.each(function(t) {
                        ...
                        }), (M.enable && i[r].inviewport || !M.enable) && "all" == i[r].lazyType && (i.loadImages(a[0], r, t), i.waitForCurrentImages(a[0], r, function() {}))
                        ...
                        !M.enable || M.enable && i[r].inviewport || M.enable && !i[r].inviewport && "wait" !== M.outof ? z(r) : (i[r].c.addClass("tp-waitforfirststart"), i[r].waitForFirstSlide = !0, M.presize && (i[r].pr_next_slide = e(i[r].slides[0]), i.loadImages(i[r].pr_next_slide[0], r, 0, !0), i.waitForCurrentImages(i[r].pr_next_slide.find(".tp-layers"), r, function() {
                            i.animateTheLayers && i.animateTheLayers({
                                slide: i[r].pr_next_key,
                                id: r,
                                mode: "preset"
                            })
                        }))), i.manageNavigation && i[r].navigation.use && i.manageNavigation(r), i[r].slideamount > 1 && (!M.enable || M.enable && i[r].inviewport ? O(r) : i[r].waitForCountDown = !0), setTimeout(function() {
    ...
    jQuery.extend(!0, t, {
        ...
        organiseCarousel: function(e, i, a, r, o) {
            ...
            if (i = s.slide_offset < s.cached_slide_offset ? "left" : "right", s.cached_slide_offset = s.slide_offset, !0 !== s.justify && "center" === s.horizontal_align) {
                ...
                g >= s.maxwidth && ("left" === i && (d = 2 * s.windhalf, c = 0 - (s.slide_width - (g - s.maxwidth))), "right" === i && (d = 2 * s.windhalf - (g - s.maxwidth), c = 0 - s.slide_width))
            }
            for (var f = 2 * s.windhalf, m = 0, v = -1, y = 0; y < s.len; y++) !0 === s.justify ? (p += y > 0 ? s.slide_widths[y - 1] + s.space : s.slide_offset, s.wrapwidth >= s.maxwidth && "center" !== s.horizontal_align && (s.slideFakePositions[y] = p - s.slide_offset), c = 0 - s.slide_widths[y], d = s.maxwidth - s.slide_widths[y], s.inneroffset = 0) : (p = y * s.slide_width + s.slide_offset, s.wrapwidth >= s.maxwidth && "left" === s.horizontal_align && (s.slideFakePositions[y] = y * s.slide_width), s.wrapwidth >= s.maxwidth && "right" === s.horizontal_align && (s.slideFakePositions[y] = s.wrapwidth - (y + 1) * s.slide_width)), h = u = p, s.infinity && (u = u >= d - s.inneroffset ? u - s.maxwidth : u <= c - s.inneroffset ? u + s.maxwidth : u), f > u && (f = u, y), m < u && (m = u, v = y), s.slidepositions[y] = h > s.maxwidth + d ? u - s.maxwidth : h < c - s.maxwidth ? u + s.maxwidth : u;
            ...
            t[e].slides && jQuery.each(t[e].slides, function(i, a) {
                var r = {
                    ...
                    d = 0;
                if (s.justify) r.autoAlpha = 1, s.wrapwidth >= s.maxwidth && "center" !== s.horizontal_align || ("center" === s.horizontal_align && s.slidepositions[i] < s.windhalf && s.slidepositions[i] + s.slide_widths[i] > s.windhalf ? s.focused = i : "left" === s.horizontal_align && s.slidepositions[i] >= -25 && s.slidepositions[i] < s.windhalf && (!_ || s.slidepositions[i] < x) ? (s.focused = i, _ = !0, x = s.slidepositions[i]) : "right" === s.horizontal_align && s.slidepositions[i] + s.slide_widths[i] <= s.wrapwidth + 25 && (s.slide_widths[i] < s.windhalf && s.slidepositions[i] > s.windhalf || s.slidepositions[i] > s.wrapwidth - s.slide_widths[i]) && (!_ || s.slidepositions[i] > x) && (s.focused = i, _ = !0, x = s.slidepositions[i]), s.focused = s.focused >= s.len ? s.infinity ? 0 : s.len - 1 : s.focused < 0 ? s.infinity ? s.len - 1 : 0 : s.focused);
                else {
                    d = "center" === s.horizontal_align ? (Math.abs(s.wrapwidth / 2) - (r.left + s.slide_width / 2)) / s.slide_width : (s.inneroffset - r.left) / s.slide_width, (Math.abs(d) < b || 0 === d) && (b = Math.abs(d), s.focused = i), void 0 !== s.minScale && s.minScale > 0 && (s.vary_scale ? r.scale = 1 - Math.abs((1 - s.minScale) / l * d) : r.scale = d >= 1 || d <= -1 ? s.minScale : s.minScale + (1 - s.minScale) * (1 - Math.abs(d)), w = d * (r.width - r.width * r.scale) / 2), s.fadeout && (s.vary_fade ? r.autoAlpha = 1 - Math.abs(s.maxOpacity / l * d) : r.autoAlpha = d >= 1 || d <= -1 ? s.maxOpacity : s.maxOpacity + (1 - s.maxOpacity) * (1 - Math.abs(d)));
                    var c = Math.ceil(s.maxVisibleItems / n) - Math.abs(d);
                    r.autoAlpha = void 0 === r.autoAlpha ? 1 : r.autoAlpha, r.autoAlpha = Math.max(0, Math.min(c, r.autoAlpha)), void 0 !== s.maxRotation && 0 != Math.abs(s.maxRotation) && (s.vary_rotation ? (r.rotationY = Math.abs(s.maxRotation) - Math.abs((1 - Math.abs(1 / l * d)) * s.maxRotation), r.autoAlpha = Math.abs(r.rotationY) > 90 ? 0 : r.autoAlpha) : r.rotationY = d >= 1 || d <= -1 ? s.maxRotation : Math.abs(d) * s.maxRotation, r.rotationY = d < 0 ? -1 * r.rotationY : r.rotationY), r.x = Math.floor(-1 * s.space * d * (s.offsetScale ? r.scale : 1)), void 0 !== r.scale && (r.x = r.x + w)
                }
                r.left = s.wrapwidth >= s.maxwidth && ("left" === s.horizontal_align || "right" === s.horizontal_align) ? s.slideFakePositions[i] : Math.floor(r.left), r.zIndex = s.justify ? 95 : Math.round(100 - Math.abs(5 * d)), r.force3D = !0, r.transformStyle = "3D" != t[e].parallax.type && "3d" != t[e].parallax.type ? "flat" : "preserve-3d", !0 !== o && punchgs.TweenLite.set(a, r)
        ...
        swipeAnimate: function(e) {
            ...
            i.swipeDistance = 0, i.positionanim = punchgs.TweenMax.to(r, .5, {
                ...
                onComplete: function() {
                    "carousel" !== t[e.id].sliderType || i.fadein || (punchgs.TweenMax.to(t[e.id].canvas, 1, {
                        scale: 1,
                        opacity: 1
                    }), i.fadein = !0), i.justDragged = !1, e.fix && (i.focusedAfterAnimation = i.focused, e.newSlide && i.focusedBeforeSwipe !== i.focused && t.callingNewSlide(e.id, jQuery(t[e.id].slides[i.focused]).data("key"), !0), t.organiseCarousel(e.id, e.direction, !0, !0), t[e.id].c.trigger("revolution.slide.carouselchange", {
                        slider: e.id,
                ...
                if (i[o].layers[e.skey].hasOwnProperty(n)) {
                    ...
                    if (g = "slide" === c.basealign ? 0 : Math.max(0, "fullscreen" == i[o].sliderLayout ? v / 2 - i.iHE(o) * (i[o].keepBPHeight ? 1 : i[o].bh) / 2 : i[o].autoHeight || null != i[o].minHeight && i[o].minHeight > 0 ? i[o].conh / 2 - i.iHE(o) * i[o].bh / 2 : g), h = "slide" === c.basealign ? 0 : Math.max(0, h), "slide" !== c.basealign && "carousel" === i[o].sliderType && c._isstatic && void 0 !== i[o].carousel && void 0 !== i[o].carousel.horizontal_align && (h = Math.max(0, "center" === i[o].carousel.horizontal_align ? 0 + (i[o].ulw - i.iWA(o, "static") * i[o].bw) / 2 : "right" === i[o].carousel.horizontal_align ? i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw : h)), "updateposition" !== e.mode) {
                        if (0 == c.vbility[i[o].levelForced] || "f" == c.vbility[i[o].levelForced] || m < i[o].hideLayerAtLimit && "on" == c.layeronlimit || m < i[o].hideAllLayerAtLimit ? c.p[0].classList.add("rs-layer-hidden") : c.p[0].classList.remove("rs-layer-hidden"), c.poster = null == c.poster && void 0 !== c.thumbimage ? c.thumbimage : c.poster, "image" === c.layertype)
                            ...
                            z = "auto" === z ? z : !jQuery.isNumeric(z) && z.indexOf("%") > 0 ? c._incolumn || c._ingroup ? "100%" : "grid" === c.basealign ? i.iWA(o, e.slideIndex) * i[o].bw : m : "off" !== c.rsp_bd ? parseFloat(z) * i[o].bw + "px" : parseFloat(z) + "px", M = "auto" === M ? M : !jQuery.isNumeric(M) && M.indexOf("%") > 0 ? "grid" === c.basealign ? i.iHE(o) * i[o].bw : v : "off" !== c.rsp_bd ? parseFloat(M) * i[o].bh + "px" : parseFloat(M) + "px";
                            var C = L(d, o);
                            if (c._incolumn && "100%" === z && "auto" === M && void 0 !== c.ytid) {
                            ...
                            } else -1 != d[0].className.indexOf("rs-fsv") || S ? (h = 0, g = 0, c.x = i.revToResp(0, i[o].rle, 0), c.y = i.revToResp(0, i[o].rle, 0), d.css({
                                width: m,
                                ...
                                width: z,
                                height: M
                            }), (0 == c.html5vid && !S || 1 != c.forcecover && !d.hasClass("rs-fsv") && !S) && (c.media.width(z), c.media.height(M)), c._ingroup && null != z && !jQuery.isNumeric(z) && z.indexOf("%") > 0 && punchgs.TweenMax.set([c.lp, c.p, c.m], {
                                minWidth: z
                            })
                        }
                        c._slidelink || A(d, o, 0, c.rsp_bd, e.slideIndex), "on" === c.rsp_ch && "row" !== c.type && "column" !== c.type && "group" !== c.type && d.find("*").each(function() {
                            var t = jQuery(this);
                            "true" !== i.gA(this, "stylerecorder") && !0 !== i.gA(this, "stylerecorder") && T(t, "rekursive", o), A(t, o, "rekursive", c.rsp_bd, e.slideIndex)
                        })
                    }
                    if ("preset" !== e.mode) {
                    ...
                    if (p.ford.hasOwnProperty(L)) {
                        ...
                        if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                            ...
                            if ("frame_999" !== I || !1 !== w || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                p.fff = "frame_1" === I && ("trigger" !== e.mode || "frame_999" === p.currentframe || "frame_0" === p.currentframe || void 0 === p.currentframe), "trigger" === e.mode && "frame_1" === e.frame && !1 === p.leftstage && (p.fff = !1), A || (p.frames[I].timeline.callstate = "called", p.currentframe = I);
                                var R = p.frames[I],
                                    ...
                                    B = H.ease;
                                "block" === O.type && (O.ft[0].background = R.sfx.fxc, z.add(punchgs.TweenMax.fromTo(O.bmask_in, P / 2, O.ft[0], O.ft[1], 0)), z.add(punchgs.TweenMax.fromTo(O.bmask_in, P / 2, O.ft[1], O.t, P / 2)), "frame_0" === I || "frame_1" === I ? N.opacity = 0 : "frame_999" === I && z.add(M.staggerFromTo(C, .05, {
                                    autoAlpha: 1
                                }, {
                                    autoAlpha: 0,
                                    delay: P / 2
                                }, 0), .001)), void 0 !== R.color ? H.color = R.color : void 0 !== p.color && "npc" !== p.color[c] && (H.color = p.color[c]), void 0 !== S && void 0 !== S.color ? N.color = S.color : void 0 !== S && void 0 !== p.color && "npc" !== p.color[c] && (N.color = p.color[c]), void 0 !== R.bgcolor ? R.bgcolor.indexOf("gradient") >= 0 ? H.background = R.bgcolor : H.backgroundColor = R.bgcolor : !0 === p.bgcolinuse && (p.bgcol.indexOf("gradient") >= 0 ? H.background = p.bgcol : H.backgroundColor = p.bgcol), void 0 !== S && (void 0 !== S.bgcolor ? S.bgcolor.indexOf("gradient") >= 0 ? N.background = S.bgcolor : N.backgroundColor = S.bgcolor : !0 === p.bgcolinuse && (p.bgcol.indexOf("gradient") >= 0 ? N.background = p.bgcol : N.backgroundColor = p.bgcol));
                                var W = 0;
                                if (void 0 !== p.splitText && !1 !== p.splitText)
                                    for (var F in t)
                                        if (void 0 !== R[t[F]] && !p.quickRendering) {
                                            ...
                                            j = void 0 === R[t[F]].delay ? .05 : R[t[F]].delay / 100, p.color[c] === H.color && "frame_1" === I || (Y.color = H.color), void 0 !== N && p.color[c] !== N.color && (V.color = N.color);
                                            var X = v(jQuery.extend(!0, {}, Y)),
                                                Z = p.fff ? v(jQuery.extend(!0, {}, V)) : void 0;
                                            delete X.dir, X.data = {
                                                splitted: !0
                                            }, void 0 !== Z && delete Z.dir, p.fff ? z.add(M.staggerFromTo(E, P, Z, X, p.frames[I].split ? j : 0, 0), 0) : z.add(M.staggerTo(E, P, X, p.frames[I].split ? j : 0, 0), 0), W = E.length > W ? E.length : W
                                        }
                                P += p.frames[I].split ? j * W : 0, p.pxundermask || void 0 !== Q && (void 0 !== S && "hidden" === S.mask.overflow || "hidden" === R.mask.overflow) ? (z.add(punchgs.TweenMax.to(p.m, .001, {
                                    overflow: "hidden"
                                }), 0), "column" === p.type && z.add(punchgs.TweenMax.to(p.cbgmask, .001, {
                                    overflow: "hidden"
                                }), 0), p.btrans && (D && (D.rotationX = p.btrans.rX, D.rotationY = p.btrans.rY, D.rotationZ = p.btrans.rZ, D.opacity = p.btrans.o), Q.rotationX = p.btrans.rX, Q.rotationY = p.btrans.rY, Q.rotationZ = p.btrans.rZ, Q.opacity = p.btrans.o), p.fff ? z.add(punchgs.TweenMax.fromTo([p.m, p.cbgmask], P, jQuery.extend(!0, {}, D), jQuery.extend(!0, {}, Q)), .001) : z.add(punchgs.TweenMax.to([p.m, p.cbgmask], P, jQuery.extend(!0, {}, Q)), .001)) : void 0 !== p.btrans ? z.add(punchgs.TweenMax.to(p.m, .001, {
                                    x: 0,
                                    y: 0,
                                    filter: "none",
                                    opacity: p.btrans.o,
...
function(e) {
    ...
    jQuery.extend(!0, t, {
        hideUnHideNav: function(e) {
            ...
            p(a) && T(t[e].c.find(".tparrows"), a.hide_under, i, a.hide_over), p(r) && T(t[e].c.find(".tp-bullets"), r.hide_under, i, r.hide_over), p(o) && T(o.c, o.hide_under, i, o.hide_over), p(s) && T(s.c, s.hide_under, i, s.hide_over), k(e)
        },
            ...
            s(e), n(e), y && (v(o, e), o.c = t[e].cpar.find(".tparrows")), t[e].slides.each(function(i) {
                if (-1 === this.className.indexOf("not-in-nav")) {
                    var a = jQuery(t[e].slides[t[e].slides.length - 1 - i]),
                        r = jQuery(this);
                    b && (t[e].navigation.bullets.rtl ? _(t[e].c, l, a, e) : _(t[e].c, l, r, e)), w && (t[e].navigation.thumbnails.rtl ? x(t[e].c, g, a, "tp-thumb", e) : x(t[e].c, g, r, "tp-thumb", e)), k && (t[e].navigation.tabs.rtl ? x(t[e].c, m, a, "tp-tab", e) : x(t[e].c, m, r, "tp-tab", e))
                }
            }), b && (l.c = t[e].cpar.find(".tp-bullets")), w && jQuery.extend(!0, g, a(e, "thumb")), k && jQuery.extend(!0, m, a(e, "tab")), t[e].c.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function(i) {
                if (void 0 !== t[e].pr_next_key || void 0 !== t[e].pr_active_key) {
                    ...
                    t[e].c.find(".tp-bullet").each(function() {
                        ...
                        t.gA(this, "key") === s ? (this.classList.add("selected"), "RS-TAB" === this.nodeName ? r(m, e) : r(g, e)) : this.classList.remove("selected")
                    });
                    var n = 0,
                        l = !1;
                    ...
                    if (!0 === o.enable) {
                        ...
                        void 0 !== t[e].thumbs[c] && (jQuery.each(t[e].thumbs[c].params, function(e, t) {
                            p = p.replace(t.from, t.to)
                        }), o.right.j.html(p), o.right.iholder = void 0 === o.right.iholder ? o.right.j.find(".tp-arr-imgholder") : o.right.iholder, o.left.iholder = void 0 === o.left.iholder ? o.left.j.find(".tp-arr-imgholder") : o.left.iholder, o.rtl ? (void 0 !== o.left.iholder[0] && punchgs.TweenLite.set(o.left.iholder, {
                            backgroundImage: "url(" + t[e].thumbs[c].src + ")"
                        }), void 0 !== t[e].thumbs[d] && void 0 !== o.right.iholder[0] && punchgs.TweenLite.set(o.right.iholder, {
                            backgroundImage: "url(" + t[e].thumbs[d].src + ")"
                        })) : (void 0 !== t[e].thumbs[d] && void 0 !== o.left.iholder[0] && punchgs.TweenLite.set(o.left.iholder, {
                            backgroundImage: "url(" + t[e].thumbs[d].src + ")"
                        }), void 0 !== o.right.iholder[0] && punchgs.TweenLite.set(o.right.iholder, {
                            backgroundImage: "url(" + t[e].thumbs[c].src + ")"
                        })))
                    }
                }
            }), c(o), c(l), c(g), c(m), t[e].cpar.on("mouseenter mousemove", function(a) {
                void 0 !== a.target && void 0 !== a.target.className && a.target.className.indexOf("rs-waction") >= 0 || t[e].cpar.hasClass("tp-mouseover") || (t[e].cpar.addClass("tp-mouseover"), t[e].firstSlideAvailable && (h(e), i && !0 !== t[e].someNavIsDragged && (u(t[e].hideAllNavElementTimer), t[e].hideAllNavElementTimer = setTimeout(function() {
                    t[e].cpar.removeClass("tp-mouseover"), f(e)
                }, 150))))
            }), t[e].cpar.on("mouseleave ", function() {
                t[e].cpar.removeClass("tp-mouseover"), f(e)
            }), (w || k || "carousel" === t[e].sliderType || t[e].navigation.touch.touchOnDesktop || t[e].navigation.touch.touchenabled && i) && d(e)
        }
    });
    var r = function(e, i) {
        ...
        d = function(e) {
            ...
            jQuery(".bullet, .bullets, .tp-bullets, .tparrows").addClass("noSwipe"), t[e].navigation.touch = void 0 === t[e].navigation.touch ? {} : t[e].navigation.touch, t[e].navigation.touch.swipe_direction = void 0 === t[e].navigation.touch.swipe_direction ? "horizontal" : t[e].navigation.touch.swipe_direction, jQuery(".rs-nav-element").rsswipe({
                ...
                swipeStatus: function(i, o, s, n, d, c, p) {
                    ...
                    var h = l("RS-THUMB", i),
                        f = (l("RS-TAB", i), "start" === o ? 0 : r ? p[0].end.x - p[0].start.x : i.pageX - a.screenX),
                        ...
                        A = "vertical" === T ? x.find(w).first().outerHeight(!0) + _.space : x.find(w).first().outerWidth(!0) + _.space,
                        R = void 0 === k.data("offset") ? 0 : parseInt(k.data("offset"), 0),
                        S = 0;
                    switch (o) {
                        case "start":
                            "vertical" === T && i.preventDefault(), a.screenX = r ? p[0].end.x : i.pageX, a.screenY = r ? p[0].end.y : i.pageY, t[e].cpar.find(v).addClass("dragged"), R = "vertical" === T ? k.position().top : k.position().left, k.data("offset", R), k.data("tmmove") && k.data("tmmove").pause(), t[e].someNavIsDragged = !0, g(e);
                            break;
                        case "move":
                            if (L <= I) return !1;
                            S = (S = R + ("vertical" === T ? m : f)) > 0 ? "horizontal" === T ? S - k.width() * (S / k.width() * S / k.width()) : S - k.height() * (S / k.height() * S / k.height()) : S;
                            var z = "vertical" === T ? 0 - (k.height() - x.height()) : 0 - (k.width() - x.width());
                            S = S < z ? "horizontal" === T ? S + k.width() * (S - z) / k.width() * (S - z) / k.width() : S + k.height() * (S - z) / k.height() * (S - z) / k.height() : S, "vertical" === T ? punchgs.TweenLite.set(k, {
                                top: S + "px"
                        ...
                        case "end":
                        case "cancel":
                            return S = R + ("vertical" === T ? m : f), S = (S = "vertical" === T ? S < 0 - (k.height() - x.height()) ? 0 - (k.height() - x.height()) : S : S < 0 - (k.width() - x.width()) ? 0 - (k.width() - x.width()) : S) > 0 ? 0 : S, S = Math.abs(n) > A / 10 ? n <= 0 ? Math.floor(S / A) * A : Math.ceil(S / A) * A : n < 0 ? Math.ceil(S / A) * A : Math.floor(S / A) * A, S = (S = "vertical" === T ? S < 0 - (k.height() - x.height()) ? 0 - (k.height() - x.height()) : S : S < 0 - (k.width() - x.width()) ? 0 - (k.width() - x.width()) : S) > 0 ? 0 : S, "vertical" === T ? punchgs.TweenMax.to(k, .5, {
                                top: S + "px",
                                ease: punchgs.Power3.easeOut
                            }) : punchgs.TweenMax.to(k, .5, {
                                left: S + "px",
                                ease: punchgs.Power3.easeOut
                            }), S = S || ("vertical" === T ? k.position().top : k.position().left), k.data("offset", S), k.data("distance", n), t[e].cpar.find(v).removeClass("dragged"), t[e].someNavIsDragged = !1, !0
                    }
                }
            }), t[e].c.rsswipe({
                allowPageScroll: "pagescroll",
        ...
        h = function(e) {
            ...
            for (var a in i) i.hasOwnProperty(a) && p(t[e].navigation[i[a]]) && (u(t[e].navigation[i[a]].showCall), t[e].navigation[i[a]].showCall = setTimeout(function(i) {
                u(i.hideCall), i.hide_onleave && !t[e].cpar.hasClass("tp-mouseover") || (void 0 === i.tween ? i.tween = m(i) : i.tween.play())
        ...
        v = function(e, i) {
            ...
            e.rtl ? (a.click(function() {
                ...
                "carousel" === t[i].sliderType && (t[i].ctNavElement = !0), t[i].sc_indicator = "arrow", t[i].sc_indicator_dir = 1, t[i].c.revprev()
            })), e.right.j = t[i].c.find(".tp-rightarrow.tparrows"), e.left.j = t[i].c.find(".tp-leftarrow.tparrows"), e.padding_top = parseInt(t[i].carousel.padding_top || 0, 0), e.padding_bottom = parseInt(t[i].carousel.padding_bottom || 0, 0), w(a, e.left, i), w(r, e.right, i), "outer-left" != e.position && "outer-right" != e.position || (t[i].outernav = !0)
        },
        y = function(e, i, a) {
        ...
        x = function(e, i, a, r, o) {
            ...
            if (i.visibleAmount = i.visibleAmount > t[o].slideamount ? t[o].slideamount : i.visibleAmount, i.sliderLayout = t[o].sliderLayout, 0 === e.parent().find(s).length) {
                ...
                var u = "<" + p + 's style="opacity:0" class="rs-nav-element ' + r + "s " + (!0 === i.span ? "tp-span-wrapper" : "") + " " + i.position + " " + i.style + '"><rs-navmask class="' + r + '-mask"><' + p + 's-wrap class="' + r + 's-inner-wrapper" style="position:relative;"></' + p + "s-wrap></rs-navmask></" + p + "s>";
            ...
            }), m.append("<" + p + ' data-liindex="' + a.index() + '" data-key="' + h + '" class="justaddedthumb ' + r + '" style="width:' + i.width + "px;height:" + i.height + 'px;">' + b + "<" + p + ">");
            ...
            }), _.removeClass("justaddedthumb"), g.addClass("nav-pos-hor-" + i.h_align), g.addClass("nav-pos-ver-" + i.v_align), g.addClass("nav-dir-" + i.direction), w(g, i, o), t.callContWidthManager(o)
        },
        k = function(e) {
                ...
                if (_.set && (!i || !1 === _.disable_onmobile)) {
                    ...
                    if (x = x < 0 ? 0 : x, !1 !== _._L) {
                        ...
                        if (_.grayscale) {
                            ...
                            T["-webkit-filter"] = void 0 === T["-webkit-filter"] ? A : T["-webkit-filter"] + " " + A, T.filter = void 0 === T.filter ? A : T.filter + " " + A
                        }
                    ...
                    if (!1 !== _.bgs) {
                        ...
                        for (var R in "top" == _.direction && c >= 0 && (k = 1), "bottom" == _.direction && c <= 0 && (k = 1), k = k > 1 ? 1 : k < 0 ? 0 : k, _.bgs)
        ...
        a = function(e) {
            ...
            if (0 == d) {
                ...
                t[a].pr_next_bg.find(".slotslide").each(function(e) {
                    A = ++A === I ? 0 : A, t[a].rotate = 1 === l.trC ? 45 : t[a].rotate, t[a].mtl.add(punchgs.TweenLite.from(this, p / 2e3, {
                        opacity: 0,
                        transformStyle: "flat",
                        transformPerspective: 600,
                        scale: 0,
                ...
                var z = t[a].pr_next_bg[0].getElementsByClassName("slotslide"),
                    M = p - p / 1.8;
                for (L = 0; L < z.length; L++) t[a].mtl.add(punchgs.TweenLite.fromTo(z[L], (p - L * (M / t[a].slots)) / 1e3, {
                    opacity: 0,
                    force3D: "auto",
                    transformPerspective: 600
                }, {
                ...
                if (7 != l.trC && 4 != l.trC || (N = 0, Q = 0), 8 == l.trC ? (t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_active_slide, {
                        zIndex: 20
